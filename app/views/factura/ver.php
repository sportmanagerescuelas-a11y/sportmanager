    ...
    <div class="d-flex justify-content-between mb-4">
        ...
        <div class="d-flex gap-2 flex-wrap justify-content-end">
            <?php if (!empty($factura['comprobante_path'])): ?>
                <a href="index.php?action=comprobante&id=<?= urlencode((string)($factura['id_factura'] ?? '')) ?>" target="_blank" class="btn btn-outline-primary">Ver comprobante</a>
            <?php endif; ?>
            <a href="index.php?action=pdf&id=<?= urlencode((string)($factura['id_factura'] ?? '')) ?>" target="_blank" class="btn btn-danger">Descargar PDF</a>
        </div>
    </div>
