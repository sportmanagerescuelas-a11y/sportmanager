        ...
        <div class="container home-hero-grid">
            <div class="home-hero-copy home-reveal">
                ...
                <div class="home-hero-stats">
                    <div class="home-stat-card">
                        <strong>+200</strong>
                        <span>Deportistas formados</span>
                    </div>
                    <div class="home-stat-card">
                        <strong>+20</strong>
                        <span>Eventos al ano</span>
                    </div>
                    <div class="home-stat-card">
                        <strong>100%</strong>
            ...
            <div class="home-hero-media">
                <div id="homeHeroCarousel" class="carousel slide home-carousel" data-bs-ride="carousel">
                    ...
                    <button class="carousel-control-next" type="button" data-bs-target="#homeHeroCarousel" data-bs-slide="next" aria-label="Siguiente">
